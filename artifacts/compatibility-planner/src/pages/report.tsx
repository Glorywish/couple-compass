    ...
    <div style={{ minHeight: "100vh", background: "#f8f4f0", color: "#1a3560", paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "52px 24px", display: "flex", flexDirection: "column", gap: 52 }}>
        ...
        <motion.div
          ...
          className="no-print"
          style={{ background: "white", border: "1px solid rgba(184,212,240,0.4)", borderRadius: 20, padding: "28px 28px", display: "flex", flexDirection: "column", alignItems: "center", gap: 14, textAlign: "center", boxShadow: "0 2px 16px rgba(26,53,96,0.05)" }}>
