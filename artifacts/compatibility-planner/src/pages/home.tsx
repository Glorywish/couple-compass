      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-16 pb-24">
        ...
        <motion.div initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }} transition={{ duration:0.8, delay:0.3, ease:[0.16,1,0.3,1] }} className="max-w-2xl mx-auto">
          ...
          <motion.div initial={{ opacity:0, y:14 }} animate={{ opacity:1, y:0 }} transition={{ delay:1.1 }}
            ...
            <span style={{ fontSize:"0.6rem", letterSpacing:"0.2em", textTransform:"uppercase", color:"rgba(26,53,96,0.35)", fontWeight:600 }}>Also on mobile</span>
            <div style={{ display:"flex", gap:10, flexWrap:"wrap", justifyContent:"center" }}>
              <a href="https://apps.apple.com" target="_blank" rel="noreferrer" style={{ position:"relative", display:"inline-flex", alignItems:"center", gap:9, background:"#1a3560", borderRadius:13, padding:"9px 18px", textDecoration:"none", boxShadow:"0 3px 14px rgba(26,53,96,0.22)", opacity:0.82 }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>
                <div>
                  <div style={{ fontSize:"0.55rem", color:"rgba(255,255,255,0.6)", letterSpacing:"0.08em", textTransform:"uppercase", lineHeight:1 }}>Download on the</div>
                  <div style={{ fontSize:"0.85rem", color:"white", fontWeight:600, fontFamily:"Inter,sans-serif", lineHeight:1.3 }}>App Store</div>
                </div>
                <span style={{ position:"absolute", top:-7, right:-4, background:"#e8607a", color:"white", fontSize:"0.45rem", fontWeight:700, letterSpacing:"0.08em", textTransform:"uppercase", borderRadius:6, padding:"2px 6px", whiteSpace:"nowrap" }}>Soon</span>
              </a>
              <a href="https://play.google.com" target="_blank" rel="noreferrer" style={{ position:"relative", display:"inline-flex", alignItems:"center", gap:9, background:"#1a3560", borderRadius:13, padding:"9px 18px", textDecoration:"none", boxShadow:"0 3px 14px rgba(26,53,96,0.22)", opacity:0.82 }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="white"><path d="M3.18 23.76c.3.17.64.24.99.2l12.19-7.03-2.56-2.56L3.18 23.76zm17.1-10.65L17.6 11.5l-2.83 2.83 2.81 2.81 2.7-1.56c.77-.45.77-1.82 0-2.27zM2.74.32A1.2 1.2 0 0 0 2.5 1v22a1.2 1.2 0 0 0 .24.68l.09.09 12.32-12.32v-.28L2.83.23l-.09.09zm11.37 12.05L2.74 23.74V.26l11.37 12.11z"/></svg>
                <div>
                  <div style={{ fontSize:"0.55rem", color:"rgba(255,255,255,0.6)", letterSpacing:"0.08em", textTransform:"uppercase", lineHeight:1 }}>Get it on</div>
                  <div style={{ fontSize:"0.85rem", color:"white", fontWeight:600, fontFamily:"Inter,sans-serif", lineHeight:1.3 }}>Google Play</div>
                </div>
                <span style={{ position:"absolute", top:-7, right:-4, background:"#e8607a", color:"white", fontSize:"0.45rem", fontWeight:700, letterSpacing:"0.08em", textTransform:"uppercase", borderRadius:6, padding:"2px 6px", whiteSpace:"nowrap" }}>Soon</span>
              </a>
            </div>
            <span style={{ fontSize:"0.62rem", color:"rgba(26,53,96,0.3)", fontStyle:"italic" }}>Polishing underway — publishing to stores very soon</span>
          </motion.div>
        </motion.div>
